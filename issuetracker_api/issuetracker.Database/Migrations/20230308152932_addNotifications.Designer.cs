...
namespace issuetracker.Database.Migrations
{
    ...
    [Migration("20230308152932_addNotifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("issuetracker.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("CreatedInId")
                        .HasColumnType("uuid")
                        .HasColumnName("created_in_id");
                    ...
                    b.HasIndex("ToUserId")
                        .HasDatabaseName("ix_notifications_to_user_id");
            ...
            modelBuilder.Entity("issuetracker.Entities.Notification", b =>
                {
                    b.HasOne("issuetracker.Entities.AppUser", "ToUser")
                        .WithMany()
                        .HasForeignKey("ToUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_notifications_users_to_user_id");
